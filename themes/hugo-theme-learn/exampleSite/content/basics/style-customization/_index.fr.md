...
Si votre favicon est un png?featherlight=false&width=90pc, déposez votre image dans votre dossier local `static/images/` et nommez le `favicon.png?featherlight=false&width=90pc`
